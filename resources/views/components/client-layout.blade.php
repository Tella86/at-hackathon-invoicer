...
<head>
    ...
    <!-- Scripts (using your app's compiled CSS/JS) -->
...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="shrink-0 flex items-center">
                            ...
                            <span class="ml-3 text-gray-500 font-semibold">Client Portal</span>
                        </div>
                    </div>

                    <!-- Right Side: Logout Button (Only show if client is authenticated) -->
        ...
        <main>
            ...
            <!-- This is where the content from your page will be injected -->
            {{ $slot }}
        </main>
    </div>
</body>

                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($invoices as $invoice)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">KES {{ number_format($invoice->total_amount, 2) }}</td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            <form action="{{ route('invoices.send', $invoice) }}" method="POST" class="inline">
                                                @csrf
                                                <button type="submit" class="text-indigo-600 hover:text-indigo-900">Send SMS</button>
                                            </form>
                                            @endif
                                        </td>
                                    </tr>
